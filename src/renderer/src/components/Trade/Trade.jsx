  ...
  return (
    <div id="trade" className="p-2">
      ...
      <div id="lots">
        ...
        <div id="lot" className="flex border rounded p-1 m-1 relative">
          ...
          <div id="lotInfo" className="flex flex-col">
            <p className="underline">
              Реконструкция сети связи в поселки Нижние Пиздюки. Возведение строительных
              конструкция, прокладка сети ХПОН
            </p>

            <p className="flex">
              Стоимость - 2 993 904, 02 BYN., строительство - 12.11.2025 - 30.11.2025, ПОС - 12 мес.
            </p>
